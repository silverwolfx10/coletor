...
--
-- Table structure for table `sys_driver`
--
...
--
-- Dumping data for table `sys_driver`
--

LOCK TABLES `sys_driver` WRITE;
/*!40000 ALTER TABLE `sys_driver` DISABLE KEYS */;
INSERT INTO `sys_driver` VALUES (1,'mysql');
/*!40000 ALTER TABLE `sys_driver` ENABLE KEYS */;
UNLOCK TABLES;
