...
LOCK TABLES `sys_clientes` WRITE;
/*!40000 ALTER TABLE `sys_clientes` DISABLE KEYS */;
INSERT INTO `sys_clientes` VALUES (1,'trilha','trilha','1234');
/*!40000 ALTER TABLE `sys_clientes` ENABLE KEYS */;
UNLOCK TABLES;
